...
<div class="position"><a href="">I'M Diors</a> > <a href="">Diors 发烧友</a> >  <a href="<%=basePath %>news/list">NEWS</a> > <a href="">投身移动互联网：小人物的...</a> </div>
...
<div class="content">
  <div class="content_left">
    ...
    <div class="news">
	  ...
	  <div class="news_center">
		...
		<div class="news_center_detail">
		  <div class="tongcheng_title">
		    ...
		    <ul>
			  <li style=" font-size:24px; color:#313131;">${news.title}<input type="hidden" id="newsId" value="${news.id}"/></li>
			  <li>章蔚玮  ${news.createTime} <span style="float:right;"><a href="">评论</a> | <a href="">赞</a> | <a href="">收藏</a></span></li>
			</ul> 
		  </div>
		  ...
		  <!--   <form action="" method="get">
			...
			<div class="ds-thread" data-thread-key="${news.id }"data-title="${news.title }"></div>
	  ...
	  <div class="bg_sen_news" style="font-size:24px;">NEWS 28/10</div>
	</div>
